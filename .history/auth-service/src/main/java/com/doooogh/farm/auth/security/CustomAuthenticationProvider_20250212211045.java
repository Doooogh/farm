...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public CustomAuthenticationProvider(UserDetailsService userDetailsService, PasswordEncoder passwordEncoder,CaptchaService captchaService) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (userDetails == null || !passwordEncoder.matches(password, userDetails.getPassword())) {
            ...
            if (attempts.incrementAndGet() >= 5) {
                ...
                String generatedCaptcha = captchaService.generateCaptcha(username);
                log.info("Generated captcha for user {}: {}", username, generatedCaptcha);
